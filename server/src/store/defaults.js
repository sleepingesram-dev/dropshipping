...
export const DEFAULT_AUTOMATIONS = [
  ...
  { id: 'review-requests', name: 'Review requests (Judge.me)', description: 'Review email 7 days after delivery; photo reviews get a discount code.', enabled: true, intervalMinutes: 360 },
